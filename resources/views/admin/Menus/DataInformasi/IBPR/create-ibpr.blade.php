...
<div class="col-xl">
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Data IBPR Baru</h5>
    </div>
    <div class="card-body">
        <form action="{{route('dataIbpr.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" name="tanggal_efektif" required/>
        </div>
        <div class="mb-3">
