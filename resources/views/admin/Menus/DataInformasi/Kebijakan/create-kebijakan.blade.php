...
<div class="col-xl">
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Data Kebijakan Baru</h5>
    </div>
    <div class="card-body">
        <form action="{{route('dataKebijakan.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label class="form-label">Upload PDF Kebijakan</label>
