...
<div class="col-xl">
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Edit Data Poster</h5>
    </div>
    <div class="card-body">
        <form action="{{route('dataPoster.update', $px->id )}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="judul" value="{{$px->judul}}" required/>
        </div>
        <div class="mb-3">
