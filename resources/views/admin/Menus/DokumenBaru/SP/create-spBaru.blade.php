...
<div class="col-xl">
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{route('dataSpBaru.store')}}" method="POST" enctype="multipart/form-data" id="multiStepForm">
                @csrf
                <div class="step-content active" id="step-1">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="jenis_doc" readonly value="SP"/>
                    </div>
                    <div class="mb-3">
...
<script>
    ...
    document.getElementById('manualSwitch').addEventListener('change', function() {
        ...
        if (this.checked) {
            ...
            inputNoDoc.focus();
            hintDoc.innerHTML = "Contoh Format: <span class='text-primary'>PPA-ADRO-SP-ICTMD-01</span>";
        } else {
    ...
    function combineAllFields() {
        ...
        fields.forEach(field => {
            ...
            if (finalInput) {
                ...
                finalInput.value = values.map((val, index) => `${index + 1}. ${val}`).join('\n');
            }
        });
