...
<div class="col-xl">
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">REVISI DOKUMEN: {{ $sopRevisi->no_dokumen }}</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('dataSopRevisi.store') }}" method="POST" enctype="multipart/form-data" id="multiStepForm">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="judul" rows="3">{{ old('judul', $sopRevisi->judul) }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div id="aktivitas-container">
                        @php 
                            ...
                            $items = explode('[END]', $sopRevisi->aktifitas_tanggung_jawab); 
                        @endphp
            ...
            .then(data => {
                ...
                if(selectPJO) {
                    ...
                    data.pjo.forEach(user => {
                        let option = new Option(`${user.nama} (NRP : ${user.nrp})`, user.nama);
                        if(user.nama === selectPJO.getAttribute('data-selected')) option.selected = true;
