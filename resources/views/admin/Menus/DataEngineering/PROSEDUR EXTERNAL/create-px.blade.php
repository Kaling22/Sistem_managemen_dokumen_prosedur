...
<div class="col-xl">
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Data PROSEDUR EXTERNAL Baru</h5>
    </div>
    <div class="card-body">
        <form action="{{route('dataPxEngineering.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="judul_px" required/>
        </div>
        <div class="mb-3">
