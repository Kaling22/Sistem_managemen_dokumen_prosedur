...
use App\Models\COE\tb_sp_coe;
use Illuminate\Support\Facades\Storage;
class spCoeController extends Controller
{
    /**
    ...
    {
        $sp = tb_sp_coe::all();
        return view ('admin.Menus.DataCOE.SP.data-sp',compact('sp'));
    }
    ...
    {
        return view ('admin.Menus.DataCOE.SP.create-sp');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dataSpCoe.index');
    }
    ...
    {
        $sp = tb_sp_coe::find($id);
        return view('admin.Menus.DataCOE.SP.edit-sp',compact('sp'));
    }
