...
use App\Models\COE\tb_jsa_coe;
use Illuminate\Support\Facades\Storage;
class jsaCoeController extends Controller
{
    /**
    ...
    {
        $jsa = tb_jsa_coe::all();
        return view ('admin.Menus.DataCOE.JSA.data-jsa',compact('jsa'));
    }
    ...
    {
        return view ('admin.Menus.DataCOE.JSA.create-jsa');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dataJsaCoe.index');
    }
    ...
    {
        $jsa = tb_jsa_coe::find($id);
        return view('admin.Menus.DataCOE.JSA.edit-jsa',compact('jsa'));
    }
