...
use App\Models\COE\tb_ik_coe;
use Illuminate\Support\Facades\Storage;
class ikCoeController extends Controller
{
    /**
    ...
    {
        $ik = tb_ik_coe::all();
        return view ('admin.Menus.DataCOE.IK.data-ik',compact('ik'));
    }
    ...
    {
        return view ('admin.Menus.DataCOE.IK.create-ik');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dataIkCoe.index');
    }
    ...
    {
        $ik = tb_ik_coe::find($id);
        return view('admin.Menus.DataCOE.IK.edit-ik',compact('ik'));
    }
