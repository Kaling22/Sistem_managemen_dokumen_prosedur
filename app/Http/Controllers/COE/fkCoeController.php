...
class fkCoeController extends Controller
{
    /**
    ...
    {
        $fk = tb_fk_coe::all();
        return view ('admin.Menus.DataCOE.FORMULIR KERJA.data-fk',compact('fk'));
    }
    ...
    {
        return view ('admin.Menus.DataCOE.FORMULIR KERJA.create-fk');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dataFkCoe.index');
    }
    ...
    {
        $fk = tb_fk_coe::find($id);
        return view('admin.Menus.DataCOE.FORMULIR KERJA.edit-fk',compact('fk'));
    }
