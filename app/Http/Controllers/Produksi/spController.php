...
class spController extends Controller
{
    ...
    {
        return view ('admin.Menus.DataProduksi.SP.create-sp');
    }
    ...
    {
        $sp = tb_sp_produksi::find($id);
        return view('admin.Menus.DataProduksi.SP.edit-sp',compact('sp'));
    }
