...
class pxHcgaController extends Controller
{
    /**
    ...
    {
        $px = tb_px_hcga::all();
        return view ('admin.Menus.DataHCGA.PROSEDUR EXTERNAL.data-px',compact('px'));
    }
    ...
    {
        return view ('admin.Menus.DataHCGA.PROSEDUR EXTERNAL.create-px');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dataPxHcga.index');
    }
    ...
    {
        $px = tb_px_hcga::find($id);
        return view('admin.Menus.DataHCGA.PROSEDUR EXTERNAL.edit-px',compact('px'));
    }
