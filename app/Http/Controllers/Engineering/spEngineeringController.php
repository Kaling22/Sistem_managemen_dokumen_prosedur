...
class spEngineeringController extends Controller
{
    ...
    {
        $spTidakAktif = tb_sp_engineering::where('status_doc', 'Inactive')->get();
        return view ('admin.Menus.DataEngineering.SP.data-sp-tidak-aktif',compact('spTidakAktif'));
    }
    ...
    {
        $sp = tb_sp_engineering::where('status_doc', 'Active')->get();
    ...
    {
        $spRevisi = tb_sp_engineering::findOrFail($id);
