...
class pxFalogController extends Controller
{
    /**
    ...
    {
        $px = tb_px_falog::all();
        return view ('admin.Menus.DataFalog.PROSEDUR EXTERNAL.data-px',compact('px'));
    }
    ...
    {
        return view ('admin.Menus.DataFalog.PROSEDUR EXTERNAL.create-px');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dataPxFalog.index');
    }
    ...
    {
        $px = tb_px_falog::find($id);
        return view('admin.Menus.DataFalog.PROSEDUR EXTERNAL.edit-px',compact('px'));
    }
