...
class jsaSheController extends Controller
{
    /**
    ...
    {
        $jsa = tb_jsa_she::all();
        return view ('admin.Menus.DataSHE.JSA.data-jsa',compact('jsa'));
    }
    ...
    {
        return view ('admin.Menus.DataSHE.JSA.create-jsa');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dataJsaShe.index');
    }
    ...
    {
        $jsa = tb_jsa_she::find($id);
        return view('admin.Menus.DataSHE.JSA.edit-jsa',compact('jsa'));
    }
